...
DETECTOR_MODEL_FILE="../supervisely-tutorials/anpr/models/eu.xml"
...
model_detector = cv2.CascadeClassifier(DETECTOR_MODEL_FILE)
...
coords = model_detector.detectMultiScale(img_orig, minNeighbors=5)
for crds in coords:
    x1, y1, x2, y2 = crds[0], crds[1], crds[0]+crds[2], crds[1]+crds[3]
